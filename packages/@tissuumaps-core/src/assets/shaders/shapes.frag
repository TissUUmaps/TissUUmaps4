...
#define SCANLINE_DATA_TEXTURE_WIDTH 4096u  // see WebGLShapesController
#define SHAPE_FILL_COLORS_TEXTURE_WIDTH 4096u  // see WebGLShapesController
#define SHAPE_STROKE_COLORS_TEXTURE_WIDTH 4096u  // see WebGLShapesController
