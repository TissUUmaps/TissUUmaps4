...
export default function Viewer() {
  // const layerList = useProjectStore((state) => state.layerList);
  ...
  //     OpenSeadragonUtils.updateLayers(viewerRef.current, oldLayers, layerList);
  //     viewerLayersRef.current = [...layerList];
  //   }
  // }, [layerList]);
    ...
    <div className="col px-0 position-relative" id="ISS_viewer_container">
      ...
      <div id="ISS_globalmarkersize" className="d-none px-1 mx-1 viewer-layer">
        ...
        <input
          ...
          max="500"
          step="10"
          // FIXME oninput="document.getElementById('ISS_globalmarkersize_label').innerHTML = this.value;"
        />
      </div>
    </div>
  );
