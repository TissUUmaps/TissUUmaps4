...
export interface LabelsLayerConfigModel
  extends PixelsLayerConfigModelBase,
    TableLayerConfigModelBase {
  /** Layer ID */
  layerId: string;
}
...
export interface LabelsGroupSettingsModel extends TableGroupSettingsModelBase {
