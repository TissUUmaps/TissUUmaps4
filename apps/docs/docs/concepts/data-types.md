...
| Labels    | Raster geometry                                   | Unsigned integer values (numeric pixel labels)    |
...
| Tables    | Vector geometry <br /> (when used as data source) | Item value (any type) or category (group name)    |
