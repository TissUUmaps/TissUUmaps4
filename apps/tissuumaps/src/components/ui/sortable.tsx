...
function Sortable<T>(props: SortableProps<T>) {
  ...
  const myOnDragStart = sortableProps.onDragStart;
  ...
  const myOnDragEnd = sortableProps.onDragEnd;
  const onDragEnd = React.useCallback(
    ...
    [value, onValueChange, onMove, getItemValue, myOnDragEnd],
  );

  const myOnDragCancel = sortableProps.onDragCancel;
  const onDragCancel = React.useCallback(
    (event: DragEndEvent) => {
      myOnDragCancel?.(event);
